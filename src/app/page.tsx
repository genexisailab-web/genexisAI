...
export default function Home() {
  ...
  return (
    <>
      ...
      <section
        id="services"
        className="relative py-12 md:flex md:items-center md:justify-center md:snap-center md:py-16"
      >
        <FadeIn once={false} className="relative mx-auto flex w-full flex-col gap-8 px-6 sm:px-10 xl:px-20">
          <div className="max-w-2xl space-y-3">
            <span className="text-xs uppercase tracking-[0.48em] text-white/55">
              Services
            </span>
            <h2 className="text-[30px] font-semibold leading-snug text-white sm:text-[36px] md:text-[42px]">
              Digital journey in one team.
            </h2>
            <p className="text-base leading-relaxed text-white/75">
              Senior Developer, designers, editors, and growth leads collaborate in weekly sprints so every release compounds momentum across channels.
            </p>
          </div>

          <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <article className="relative overflow-hidden rounded-[28px] border border-white/12 bg-gradient-to-br from-[#311944]/85 via-[#1A0C2A]/88 to-[#090312]/92 p-8 text-white shadow-[0_28px_84px_rgba(8,3,20,0.45)]">
            ...
            <div className="grid gap-4 sm:grid-cols-2 sm:gap-5">
              {supportingServices.map((service, index) => {
                ...
                return (
                  <article
                    key={service.id}
                    className="group relative overflow-hidden rounded-[24px] border border-white/12 bg-white/5 p-6 text-white backdrop-blur-lg transition hover:border-white/25"
                  >
      ...
      <section className="relative py-24 md:flex md:min-h-screen md:items-center md:justify-center md:snap-center md:py-32">
        <FadeIn once={false} className="relative mx-auto w-full px-6 sm:px-10 xl:px-24">
          <div className="relative overflow-hidden rounded-[40px] border border-white/12 bg-gradient-to-br from-[#2F1650]/70 via-[#160921]/88 to-[#07030F]/95 p-12 sm:p-16 text-white shadow-[0_35px_120px_rgba(7,3,18,0.5)]">
            ...
            <div className="relative grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                {metrics.map((metric, index) => (
                  <div
                    key={metric.label}
                    className={`relative overflow-hidden rounded-3xl border border-white/15 bg-white/[0.08] p-8 backdrop-blur-xl transition ${
      ...
      <section className="relative py-24 md:flex md:min-h-screen md:items-center md:justify-center md:snap-center md:py-32">
        <FadeIn once={false} className="mx-auto w-full space-y-12 px-6 sm:px-10 xl:px-24">
            ...
            <div className="grid gap-10 lg:grid-cols-3">
              {process.map((step, index) => {
                ...
                return (
                  <article
                    key={step.title}
                    className="group relative overflow-hidden rounded-[30px] border border-white/12 bg-gradient-to-br from-[#22102F]/85 via-[#17091F]/90 to-[#0B0312]/92 p-10 text-white shadow-[0_25px_80px_rgba(8,4,20,0.42)]"
                  >
      ...
      <section className="relative py-24 md:flex md:min-h-screen md:items-center md:justify-center md:snap-center md:py-32">
        <FadeIn once={false} className="mx-auto w-full space-y-12 px-6 sm:px-10 xl:px-24">
          ...
          <div className="grid gap-8 xl:grid-cols-[1.05fr_0.95fr]">
            <article className="relative overflow-hidden rounded-[36px] border border-white/12 bg-gradient-to-br from-[#35174F]/80 via-[#1D0C2E]/88 to-[#090314]/95 p-12 text-white shadow-[0_35px_100px_rgba(10,5,25,0.45)]">
              ...
              <div className="relative flex h-full flex-col justify-between gap-10">
                <div className="space-y-3">
                  ...
                  <h3 className="text-4xl font-semibold">{featuredHighlight.title}</h3>
                  <p className="text-lg text-white/75">{featuredHighlight.summary}</p>
                </div>
            ...
            <div className="grid gap-6">
              {supportingHighlights.map((item) => (
                <Link
                  key={item.title}
                  href={item.href}
                  className="group relative overflow-hidden rounded-3xl border border-white/12 bg-white/[0.06] p-10 text-white backdrop-blur-xl transition hover:border-white/25"
                >
      ...
      <section className="relative py-24 md:flex md:min-h-screen md:items-center md:justify-center md:snap-center md:py-32">
        <FadeIn once={false} className="mx-auto w-full space-y-12 px-6 sm:px-10 xl:px-24">
          ...
          <div className="grid gap-10 xl:grid-cols-[1.15fr_0.85fr]">
            <article className="relative overflow-hidden rounded-[36px] border border-white/12 bg-gradient-to-br from-[#2D1444]/85 via-[#160823]/90 to-[#08020F]/95 p-12 text-white shadow-[0_30px_110px_rgba(8,4,20,0.5)]">
            ...
            <div className="grid gap-6">
              {additionalTestimonials.map((testimonial) => (
                <article
                  ...
                  className="relative overflow-hidden rounded-3xl border border-white/12 bg-white/[0.06] p-10 text-white backdrop-blur-xl transition hover:border-white/25"
                >
      ...
      <section className="relative py-24 md:flex md:min-h-screen md:items-center md:justify-center md:snap-center md:py-32">
        <FadeIn once={false} className="mx-auto w-full px-6 sm:px-10 xl:px-24">
          <CtaBanner />
        </FadeIn>
      </section>
    </>
